# Optical Character Recognition with OpenCV and PyTesseract
![ocr system](/decorative-elements/ocr-dg-00.png)

## Side Note
- This is an Optical Character Recognition System working adaptable to multiple languages. The multi-lingual OCR system is Jupyter Notebook based, adaptable with OpenCV and Pytesseract module.
...
- Additional language models can be added to the system and thus used as per requirements. 
...
This output represents that the system identifies the characters' position in the input file (png) and segments them, creating and combining characters to create words. The system is not AI based thus it lacks the ability to assess the meaningful words. 

**Principle**
The principle is to recognise the characters, combine them and output them as a string.
